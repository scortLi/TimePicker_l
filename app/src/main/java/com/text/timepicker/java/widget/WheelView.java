...
public class WheelView extends View {
	 ...
	 * ��ǰѡ����  �� ���� �� ��ɫ
	 */
	private static final int VALUE_TEXT_COLOR = 0xFF00a2ff;
	 ...
	 * ѡ�� �� ���� �� ��ɫ
	 */
	private static final int ITEMS_TEXT_COLOR = 0xFFaaadaf;
	...
	private void initData(Context context) {
		mLineBorder = context.getResources().getDimensionPixelSize(R.dimen.all_border_width_onepx);
		TEXT_SIZE = context.getResources().getDimensionPixelSize(R.dimen.date_time_picker_obj_word_size);
		ADDITIONAL_ITEMS_SPACE = context.getResources().getDimensionPixelSize(R.dimen.date_time_picker_obj_word_word_mar);
		ADDITIONAL_ITEM_HEIGHT = context.getResources().getDimensionPixelSize(R.dimen.date_time_picker_obj_word_word_mar);
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setShadowLayer(0, 0, 0, 0xFFaaadaf);
		}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		centerDrawable.setBounds(-1 * mLineBorder, center - offset, getWidth()+mLineBorder, center + offset);
